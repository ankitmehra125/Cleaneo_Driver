...
class CashCollectedtabs extends StatefulWidget {
  const CashCollectedtabs({Key? key}) : super(key: key);

  @override
  _CashCollectedtabsState createState() => _CashCollectedtabsState();
}

class _CashCollectedtabsState extends State<CashCollectedtabs> {
