import 'package:cleaneo_driver_app/Home/StartTrip/components/openBottomSummary2.dart';
import 'package:dotted_line/dotted_line.dart';
import 'package:flutter/cupertino.dart';
import 'package:flutter/material.dart';
import 'package:flutter_profile_picture/flutter_profile_picture.dart';

class OpenBottomSummary
{
  static void _openBottomOrderSummary(BuildContext context) {
    ...
    var _itemValue = ValueNotifier<int>(1);
                                      ...
                                      children: [
                                        ...
                                        Column(
                                          children: [
                                            ...
                                            Container(
                                              width: mQuery.size.width * 0.105,
                                              height: mQuery.size.height * 0.0015,
                                              color: Color(0xff009c1a),
                                            )
                                          ],
                                        ),
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          SizedBox(width: mQuery.size.width * 0.26),
                                          Image.asset(
                                            "assets/images/drawer-images/edit.png",
                                            color: Color(0xff29b2fe),
                                            width: mQuery.size.width * 0.04,
